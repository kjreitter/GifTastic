var athletesArray = ["Derek Jeter", "Michael Jordan", "Lawrence Taylor", "Dan Marino", "Babe Ruth"];
...
function searchGif(gifName) {
    $.ajax({
            url: 'https://api.giphy.com/v1/gifs/search?q= ' + gifName + ' VwRRaagzKMfqq7jWwOS0KfMSYI2zGaTT ',
            type: 'GET',
        })
